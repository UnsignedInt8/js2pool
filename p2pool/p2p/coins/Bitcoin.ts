...
export default class Bitcoin {
    ...
    static readonly VERSION_CHECK = (v: number) => v >= 100000 ? undefined : 'Bitcoin version too old. Upgrade to 0.11.2 or newer!'; //# not a bug.BIP65 support is ensured by SOFTFORKS_REQUIRED
    static readonly VERSION_WARNING = (v: number) => undefined;
