...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/21b4f7907c8514ead404321a9ae806a359ca9640/kafka-node/index.d.ts
declare module 'kafka-node' {
    ...
    export class Consumer {
        ...
        on(eventName: string, cb: (message: { topic: string, value: string, offset: number, parition: number, highWaterOffset: number, key: number }) => any): void;
        on(eventName: string, cb: (error: any) => any): void;
